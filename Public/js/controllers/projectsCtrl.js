    ...
    this.projects = [
        {
            ...
            text: "As our final group project at DevMountain, we contracted with the LDS Church to create a simple billboard tracking app. I lead a team of five to create this app, coordinating workflows. Multiple views, using the Google Maps API"
        },
        {
            ...
            text: "A simple fan site for one of my favorite games, Smite. I created this project as a method to practice the languages I learned during my time at DevMountain. It is a project still in progress, but allowed me to play around with a couple interesting API's and CRUD calls."
        },
        {
